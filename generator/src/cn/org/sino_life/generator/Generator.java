...
import cn.org.sino_life.generator.util.AntPathMatcher;
import cn.org.sino_life.generator.util.BeanHelper;
import cn.org.sino_life.generator.util.FileHelper;
import cn.org.sino_life.generator.util.FreemarkerHelper;
	...
	private class TemplateProcessor {
		...
		private void executeGenerate(File templateRootDir,Map templateModel, Map filePathModel ,File srcFile) throws SQLException, IOException,TemplateException {
            ...
            try {
            	/****
        		 * 得到输出文件的路径名，
        		 * 如：java\com/sinolife/product/basic\po\DelAtestStudent2Po.java
        		 */
                String outputFilepath = proceeForOutputFilepath(filePathModel,templateFile);    
                //初始化控制代码生成的属性
